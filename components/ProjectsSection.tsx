...
const ProjectsSection = () => {
  ...
  return (
    <div id="projects" className="w-full flex flex-col mt-20 px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 w-full gap-10 lg:gap-5 mt-20 relative">
            <div ref={projectOneRef} className={`card projects-gradient-border rounded-3xl h-[450px] md:h-[400px] w-[320px] md:w-[400px] justify-self-center ${isProjectOneInView ? 'translate-x-0 opacity-100' : 'translate-x-[-100px] opacity-0'} transition-all duration-[1500ms]`}>
                <div className="projects-inner-box rounded-3xl flex flex-col py-5 relative">
                    ...
                    <div className="flex flex-row w-full justify-around absolute bottom-5 md:bottom-10">
                        <a href="https://github.com/Aijazbir2010/PermanWebsite" target="_blank" rel="noopener noreferrer" className="bg-white py-3 flex justify-center items-center rounded-full w-32 md:w-36 gap-2">
                            <i className="fa-brands fa-2xl fa-github"></i>
                            <span className="font-bold text-lg">Github</span>
                        </a>
                        <a href="https://drive.google.com/file/d/1KfsFivZeok4DiCufXwqlmRL4yuV_leb1/preview" target="_blank" rel="noopener noreferrer" className="bg-[#35FF69] py-3 flex justify-center items-center rounded-full w-32 md:w-36 gap-2">
            ...
            <div ref={projectTwoRef} className={`card projects-gradient-border rounded-3xl h-[450px] md:h-[400px] w-[320px] md:w-[400px] justify-self-center ${isProjectTwoInView ? 'translate-x-0 opacity-100' : 'translate-x-[100px] opacity-0'} transition-all duration-[1500ms]`}>
                <div className="projects-inner-box rounded-3xl flex flex-col py-5 relative">
                    <div className="w-full flex flex-row gap-4 justify-center items-center">
                    ...
                    <div className="px-6 md:px-4 mt-5">
                        <span className="text-gradient text-lg tracking-wide font-bold">Link - <a href="https://pokesphere-alpha.vercel.app" target="_blank" rel="noopener noreferrer" className="text-[#35FF69]">https://pokesphere-alpha.vercel.app</a></span>
                    </div>

                    <div className="flex flex-row w-full justify-around absolute bottom-5 md:bottom-10">
                        <a href="https://github.com/Aijazbir2010/PokeSphere" target="_blank" rel="noopener noreferrer" className="bg-white py-3 flex justify-center items-center rounded-full w-32 md:w-36 gap-2">
                            <i className="fa-brands fa-2xl fa-github"></i>
                            <span className="font-bold text-lg">Github</span>
                        </a>
                        <a href="https://drive.google.com/file/d/13fMEaDEqTlONL3QRJ9Idx1JAGJ7HLaD6/preview" target="_blank" rel="noopener noreferrer" className="bg-[#35FF69] py-3 flex justify-center items-center rounded-full w-32 md:w-36 gap-2">
                            <i className="fa-solid fa-lg fa-play text-white"></i>
                            <span className="font-bold text-lg text-white">Video</span>
                        </a>
                    </div>
        ...
        <div ref={textRef} className={`w-[90%] flex justify-center text-center mt-20 mx-auto ${isProjectOneInView ? 'translate-y-0 opacity-100' : 'translate-y-[60px] opacity-0'} transition-all duration-[1500ms]`}>
            <span className="text-white font-bold text-xl md:text-3xl">The listed projects showcase some of my best work, but I&apos;ve also created several other projects while learning and honing my web development skills. Stay tuned for my upcoming project—a <span className="font-black text-gradient">Chat Application</span> that&apos;s currently in the works!</span>
        </div>
    </div>
  )
}
